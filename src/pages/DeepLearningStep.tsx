...
export default function DeepLearningStep() {
    const deepLearningOptions = [
        {
            name: "Hybrid CNN-GRU",
            value: ModelSelectionValue.CNN_GRU,
    ...
    const handleSubmitAction = async () => {
        ...
        setIsLoading(true)
        try {
            const step1Model = state.mlModel;
            const step2Model = step1Model !== "" ? selectedModel : selectedModel + "_abnormal";
            ...
            toast.error(`Error occurs: ${err || "Unknown error"}`);
            console.error(err);
        } finally {
            setIsLoading(false);
        }
